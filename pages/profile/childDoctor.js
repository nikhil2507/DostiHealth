...
const childDoctor = () => {
    return (
        <View style={{height: "100%", width: "100%"}}>
            ...
            <Text style={styles.upText}>{'Expenses of March 11, 2020 7:19 PM \n                                            For Hemant'}</Text>
            ...
            <View style={{backgroundColor: '#FFF', width: "80%", height: 41, borderRadius: 40, right: "3%", elevation:3}}>
            ...
            <View style={{backgroundColor: '#FFF', width: "70%", height: 41, borderRadius: 40, right: "3%", top: "7%", elevation: 3}}>
            ...
            <View style={styles.cardBoxTwo}>
                ...
                <Text style={{fontSize: 18, color: '#334856', fontWeight: 'bold'}}>Rs 0</Text>
            </View>
